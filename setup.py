...
METADATA = {
    ...
    'description':      'A PyWeek Game, brought to you by the letters P and Y and the number 14',
    'author':           'Bjornicus and Suzannicus',
    #'author_email':     '',
...
PACKAGEDATA = {
    ...
    'package_dir': {'sparkles': 'sparkles',
                   },
    'packages': ['sparkles',
                ],
    'scripts': ['scripts/sparkles'],
}
...
_DATA_DIR = os.path.join('sparkles', 'data')
data = []
...
data_dirs = [os.path.join(f2.replace(_DATA_DIR, 'data')) for f2 in data]
PACKAGEDATA['package_data'] = {'sparkles': data_dirs}
...
src = []
add_files(src,os.walk('sparkles'))
